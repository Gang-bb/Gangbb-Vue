package com.gangbb.core.security.utils;
...
public class SecurityUtils
{
    ...
    public static String getUsername()
    {
        ...
        {
            String msg = "获取用户账户异常。" + e.getMessage();
    ...
    public static SysUserDTO getLoginUser()
    {
        try
        {
            return (SysUserDTO) getAuthentication().getPrincipal();
        }
        catch (Exception e)
        {
            String msg = "获取用户信息异常。" + e.getMessage();
            throw new ApiException("B0001", msg);
        }
    }
