...
import com.gangbb.core.security.filter.JwtAuthenticationTokenFilter;
import com.gangbb.core.security.handle.AuthenticationEntryPointImpl;
import com.gangbb.core.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
     ...
     * 自定义用户认证逻辑
     */
    @Qualifier("GangbbUserDetailsService")
    @Autowired
